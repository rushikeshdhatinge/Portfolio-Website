          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3 group">
              <div className="relative">
                <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-lg flex items-center justify-center transform transition-transform group-hover:scale-110">
                  <span className="text-white font-bold text-lg">R</span>
                </div>
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-lg opacity-0 group-hover:opacity-20 blur-lg transition-opacity duration-300"></div>
              </div>
              <div className="hidden sm:block">
                <span className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
                  Rushikesh
                </span>
                <div className="text-xs text-slate-400 -mt-1 tracking-wider">DEVELOPER</div>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#certificates" className="text-slate-300 hover:text-cyan-400 transition-colors">Certificates</a>
      ...
      <footer className="bg-slate-950 border-t border-slate-800">
        <div className="max-w-6xl mx-auto px-6 py-8">
          <div className="text-center text-slate-400">
            <p>&copy; 2024 Rushikesh. Crafted with passion and precision.</p>
          </div>
        </div>
      </footer>
    </div>
